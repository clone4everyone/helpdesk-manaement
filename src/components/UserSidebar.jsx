...
import { LayoutDashboard, Plus, FileText, User, ChevronRight } from 'lucide-react';

const UserSidebar = ({ activeTab, setActiveTab, isOpen, onClose }) => {
  const menuItems = [
    { id: 'dashboard', label: 'Dashboard', icon: LayoutDashboard },
    { id: 'newticket', label: 'New Ticket', icon: Plus },
    { id: 'mytickets', label: 'My Ticket', icon: FileText },
